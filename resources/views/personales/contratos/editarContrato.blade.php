                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control  @error('fecha_inicio_contrato') is-invalid @enderror" name="fecha_inicio_contrato" id="fecha_inicio_contrato" value="{{ $detalleContrato->fecha_inicio_contrato}}" readonly>
